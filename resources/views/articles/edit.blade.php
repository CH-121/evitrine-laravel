...
<div class="d-flex justify-content-center">
 <div class="container col-6  ">
    <div class="jumbotron d-flex justify-content-center bg-dark text-white">
        ...
        <input type="text" name="joursEchantillon" class="form-control ml-2 col-lg" value="{{ $article->joursEchantillon }}" >
        </div>
        ...
        <button type="submit" class="btn btn-warning offset-4 ">Modifier</button>
        </form>
